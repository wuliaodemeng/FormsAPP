...
public class Form11 extends Activity{
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.form11);
        ...
        mTabhost1.setup();
        mTabhost2.setup();
        mTabHost.addTab(mTabHost.newTabSpec("Tab Time1").setIndicator("环境应急资源").setContent(R.id.tab1));
        mTabHost.addTab(mTabHost.newTabSpec("Tab Time2").setIndicator("企业周围环境").setContent(R.id.tab2));
