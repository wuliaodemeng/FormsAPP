...
public class Form_12 extends AppCompatActivity implements TabLayout.OnTabSelectedListener, TabFragment.CallBackValue{
    ...
    private Model10 model = new Model10();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.form_12);
        tab1.setClassID(310);
        tab2.setClassID(310);
        tab3.setClassID(310);
        tab4.setClassID(310);
        ...
        tab6.setClassID(310);
        tab7.setClassID(310);
        model = (Model10) getIntent().getSerializableExtra("model10");
        ...
        imageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("data_model10", model);
        ...
        if(model != null) {
            ...
            tab6.setText(model.getText(5));
            tab7.setText(model.getText(6));
        ...
        tab1.setResource(R.layout.model10_tab1);
        tab2.setResource(R.layout.model10_tab2);
        tab3.setResource(R.layout.model10_tab6);
        tab4.setResource(R.layout.model10_tab3);
        tab5.setResource(R.layout.model10_tab4);
        tab6.setResource(R.layout.model10_tab5);
        tab7.setResource(R.layout.model10_tab7);
    ...
    public class TabPagerAdapter extends FragmentPagerAdapter {
        ...
        public CharSequence getPageTitle(int position) {
            Drawable drawable;
            drawable = ContextCompat.getDrawable(Form_12.this, R.drawable.other_page);
            drawable.setBounds(0, 0, drawable.getIntrinsicWidth(), drawable.getIntrinsicHeight());
    ...
    public void SendChoice(int choice, int i){
        ...
        else Toast.makeText(Form_12.this, "model空指针!", Toast.LENGTH_SHORT).show();
