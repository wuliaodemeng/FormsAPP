...
public class Common_4 extends AppCompatActivity implements TabLayout.OnTabSelectedListener, TabFragment.CallBackValue{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tab1.setTitle("生产工艺及设备");tab2.setTitle("生产工艺及设备");
        tab3.setTitle("生产工艺及设备");tab4.setTitle("生产工艺及设备");
        tab5.setTitle("生产工艺及设备");tab6.setTitle("生产工艺及设备");
        tab7.setTitle("生产工艺及设备");

        model = (Common_Model) getIntent().getSerializableExtra("model4");
        ...
        imageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("data_model4", model);
        ...
        tab1.setResource(R.layout.model4_tab1);
        tab2.setResource(R.layout.add_tab6);
        tab3.setResource(R.layout.add_tab7);
        tab4.setResource(R.layout.model5_tab7);
        tab5.setResource(R.layout.model5_tab2);
    ...
    public class TabPagerAdapter extends FragmentPagerAdapter {
        ...
        public CharSequence getPageTitle(int position) {
            Drawable drawable;
            drawable = ContextCompat.getDrawable(Common_4.this, R.drawable.other_page);
    ...
    public void SendChoice(int choice, int i){
        ...
        else Toast.makeText(Common_4.this, "model空指针!", Toast.LENGTH_SHORT).show();
