...
public class Common_1 extends AppCompatActivity implements TabLayout.OnTabSelectedListener, TabFragment.CallBackValue{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tab1.setTitle("环保手续、安全相关");
        tab2.setTitle("环保手续、安全相关");
        tab3.setTitle("环保手续、安全相关");
        tab4.setTitle("环保手续、安全相关");

        model = (Common_Model) getIntent().getSerializableExtra("model1");
        ...
        imageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("data_model1", model);
        ...
        tab1.setResource(R.layout.model1_tab1);
        tab2.setResource(R.layout.add_tab1);
        tab3.setResource(R.layout.model1_tab3);
        tab4.setResource(R.layout.model1_tab4);
    ...
    public void onTabReselected(TabLayout.Tab tab) {
        Drawable drawable;
        drawable = ContextCompat.getDrawable(this, R.drawable.cur_page);
    ...
    public class TabPagerAdapter extends FragmentPagerAdapter {
        ...
        public CharSequence getPageTitle(int position) {
            Drawable drawable;
            drawable = ContextCompat.getDrawable(Common_1.this, R.drawable.other_page);
            drawable.setBounds(0, 0, drawable.getIntrinsicWidth(), drawable.getIntrinsicHeight());
    ...
    public void SendChoice(int choice, int i){
        ...
        else Toast.makeText(this, "model空指针!", Toast.LENGTH_SHORT).show();
