...
public class Form_3 extends AppCompatActivity implements TabLayout.OnTabSelectedListener, TabFragment.CallBackValue{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        model = (Model1) getIntent().getSerializableExtra("model1");
        ...
        tab2.setResource(R.layout.model1_tab2);
    ...
    public void onTabReselected(TabLayout.Tab tab) {
        Drawable drawable;
        drawable = ContextCompat.getDrawable(Form_3.this, R.drawable.cur_page);
    ...
    public class TabPagerAdapter extends FragmentPagerAdapter {
        ...
        public CharSequence getPageTitle(int position) {
            Drawable drawable;
            drawable = ContextCompat.getDrawable(Form_3.this, R.drawable.other_page);
            drawable.setBounds(0, 0, drawable.getIntrinsicWidth(), drawable.getIntrinsicHeight());
    ...
    public void SendChoice(int choice, int i){
        ...
        else Toast.makeText(Form_3.this, "model空指针!", Toast.LENGTH_SHORT).show();
