...
public class Form_6 extends AppCompatActivity implements TabLayout.OnTabSelectedListener, TabFragment.CallBackValue{
    ...
    private Model4 model = new Model4();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        model = (Model4) getIntent().getSerializableExtra("model4");
        ...
        tab2.setResource(R.layout.model4_tab2);
        tab3.setResource(R.layout.model4_tab3);
        tab4.setResource(R.layout.model4_tab4);
        tab5.setResource(R.layout.model4_tab5);
    ...
    public class TabPagerAdapter extends FragmentPagerAdapter {
        ...
        public CharSequence getPageTitle(int position) {
            Drawable drawable;
            drawable = ContextCompat.getDrawable(Form_6.this, R.drawable.other_page);
    ...
    public void SendChoice(int choice, int i){
        ...
        else Toast.makeText(Form_6.this, "model空指针!", Toast.LENGTH_SHORT).show();
