...
public class Mining_5 extends AppCompatActivity implements TabLayout.OnTabSelectedListener, TabFragment.CallBackValue{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        model = (Common_Model) getIntent().getSerializableExtra("model5");
        ...
        tab1.setResource(R.layout.mining_tab48);
        tab2.setResource(R.layout.mining_tab6);
        tab3.setResource(R.layout.mining_tab7);
        tab4.setResource(R.layout.mining_tab8);
        tab5.setResource(R.layout.mining_tab9);
        tab6.setResource(R.layout.mining_tab10);
        tab7.setResource(R.layout.mining_tab_2);
    ...
    public class TabPagerAdapter extends FragmentPagerAdapter {
        ...
        public CharSequence getPageTitle(int position) {
            Drawable drawable;
            drawable = ContextCompat.getDrawable(Mining_5.this, R.drawable.other_page);
    ...
    public void SendChoice(int choice, int i){
        ...
        else Toast.makeText(Mining_5.this, "model空指针!", Toast.LENGTH_SHORT).show();
