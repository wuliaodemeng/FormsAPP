...
public class Form_11 extends AppCompatActivity implements TabLayout.OnTabSelectedListener, TabFragment.CallBackValue{
    ...
    private Model9 model = new Model9();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tab6.setClassID(39);
        tab7.setClassID(39);
        model = (Model9) getIntent().getSerializableExtra("model9");
    ...
    public void SendChoice(int choice, int i){
        ...
        else Toast.makeText(Form_11.this, "model空指针!", Toast.LENGTH_SHORT).show();
