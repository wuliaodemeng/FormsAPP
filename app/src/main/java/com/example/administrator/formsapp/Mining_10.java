...
public class Mining_10 extends AppCompatActivity implements TabLayout.OnTabSelectedListener, TabFragment.CallBackValue{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        model = (Common_Model) getIntent().getSerializableExtra("model10");
        ...
        if(model != null) {
            ...
            tab6.setLack_project(model.getLack_project(5));
            tab7.setLack_project(model.getLack_project(6));
        ...
        tab1.setResource(R.layout.mining_tab34);
        tab2.setResource(R.layout.mining_tab35);
        tab3.setResource(R.layout.mining_tab36);
        tab4.setResource(R.layout.mining_tab37);
        tab5.setResource(R.layout.mining_tab38);
        tab6.setResource(R.layout.mining_tab39);
        tab7.setResource(R.layout.mining_tab40);
    ...
    public class TabPagerAdapter extends FragmentPagerAdapter {
        ...
        public CharSequence getPageTitle(int position) {
            Drawable drawable;
            drawable = ContextCompat.getDrawable(Mining_10.this, R.drawable.other_page);
    ...
    public void SendChoice(int choice, int i){
        ...
        else Toast.makeText(Mining_10.this, "model空指针!", Toast.LENGTH_SHORT).show();
