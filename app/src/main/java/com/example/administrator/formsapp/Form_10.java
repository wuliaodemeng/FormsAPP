...
public class Form_10 extends AppCompatActivity implements TabLayout.OnTabSelectedListener, TabFragment.CallBackValue{
    ...
    private Model8 model = new Model8();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        model = (Model8) getIntent().getSerializableExtra("model8");
        ...
        tab1.setResource(R.layout.model8_tab1);
        tab2.setResource(R.layout.model8_tab2);
        tab3.setResource(R.layout.model10_tab8);
    ...
    public class TabPagerAdapter extends FragmentPagerAdapter {
        ...
        public CharSequence getPageTitle(int position) {
            Drawable drawable;
            drawable = ContextCompat.getDrawable(Form_10.this, R.drawable.other_page);
