...
public class Mining_12 extends AppCompatActivity implements TabLayout.OnTabSelectedListener, TabFragment.CallBackValue{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.form_6);
        ...
        model = (Common_Model) getIntent().getSerializableExtra("model12");
        ...
        imageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("data_model12", model);
        ...
        if(model != null) {
            ...
            tab4.setText(model.getText(3));
            tab5.setText(model.getText(4));
        ...
        tab1.setResource(R.layout.mining_tab42);
        tab2.setResource(R.layout.mining_tab43);
        tab3.setResource(R.layout.mining_tab_5);
        tab4.setResource(R.layout.mining_tab_6);
        tab5.setResource(R.layout.mining_tab_8);
    ...
    public class TabPagerAdapter extends FragmentPagerAdapter {
        ...
        public CharSequence getPageTitle(int position) {
            Drawable drawable;
            drawable = ContextCompat.getDrawable(Mining_12.this, R.drawable.other_page);
    ...
    public void SendChoice(int choice, int i){
        ...
        else Toast.makeText(Mining_12.this, "model空指针!", Toast.LENGTH_SHORT).show();
