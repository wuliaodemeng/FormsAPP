...
public class Mining_4 extends AppCompatActivity implements TabLayout.OnTabSelectedListener, TabFragment.CallBackValue{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tab1.setResource(R.layout.mining_tab1);
        tab2.setResource(R.layout.mining_tab2);
        tab3.setResource(R.layout.mining_tab3);
        tab4.setResource(R.layout.mining_tab4);
        tab5.setResource(R.layout.mining_tab5);
    ...
    public class TabPagerAdapter extends FragmentPagerAdapter {
        ...
        public CharSequence getPageTitle(int position) {
            Drawable drawable;
            drawable = ContextCompat.getDrawable(Mining_4.this, R.drawable.other_page);
    ...
    public void SendChoice(int choice, int i){
        ...
        else Toast.makeText(Mining_4.this, "model空指针!", Toast.LENGTH_SHORT).show();
