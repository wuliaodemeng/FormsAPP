...
public class Mining_6 extends AppCompatActivity implements TabLayout.OnTabSelectedListener, TabFragment.CallBackValue{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tab1.setResource(R.layout.mining_tab11);
        tab2.setResource(R.layout.mining_tab12);
        tab3.setResource(R.layout.mining_tab13);
        tab4.setResource(R.layout.mining_tab14);
        tab5.setResource(R.layout.mining_tab15);
    ...
    public class TabPagerAdapter extends FragmentPagerAdapter {
        ...
        public CharSequence getPageTitle(int position) {
            Drawable drawable;
            drawable = ContextCompat.getDrawable(Mining_6.this, R.drawable.other_page);
    ...
    public void SendChoice(int choice, int i){
        ...
        else Toast.makeText(Mining_6.this, "model空指针!", Toast.LENGTH_SHORT).show();
