...
public class Common_3 extends AppCompatActivity implements TabLayout.OnTabSelectedListener, TabFragment.CallBackValue{
    ...
    public class TabPagerAdapter extends FragmentPagerAdapter {
        ...
        public CharSequence getPageTitle(int position) {
            Drawable drawable;
            drawable = ContextCompat.getDrawable(Common_3.this, R.drawable.other_page);
    ...
    public void SendChoice(int choice, int i){
        ...
        else Toast.makeText(Common_3.this, "model空指针!", Toast.LENGTH_SHORT).show();
