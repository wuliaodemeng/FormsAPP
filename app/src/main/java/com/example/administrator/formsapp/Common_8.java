...
public class Common_8 extends AppCompatActivity implements TabLayout.OnTabSelectedListener, TabFragment.CallBackValue{
    ...
    private ImageView picture[] = new ImageView[2];
    private Uri imageUri[] = new Uri[2];
    private int id = 0;

    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.form_10);

        tab1.setClassID(18);
        tab2.setClassID(18);

        tab1.setTitle("环境应急资源");
        tab2.setTitle("环境应急资源");
    ...
    public class TabPagerAdapter extends FragmentPagerAdapter {
        ...
        public CharSequence getPageTitle(int position) {
            Drawable drawable;
            drawable = ContextCompat.getDrawable(Common_8.this, R.drawable.other_page);
    ...
    public void SendChoice(int choice, int i){
        ...
        else Toast.makeText(Common_8.this, "model空指针!", Toast.LENGTH_SHORT).show();
