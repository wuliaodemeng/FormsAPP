...
public class Common_7 extends AppCompatActivity implements TabLayout.OnTabSelectedListener, TabFragment.CallBackValue{
    ...
    private ImageView picture[] = new ImageView[6];
    private Uri imageUri[] = new Uri[6];
    private int id = 0;

    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.form_13);
        ...
        tab1.setTitle("废气、废水环境保护控制设施");
        tab2.setTitle("废气、废水环境保护控制设施");
        tab3.setTitle("废气、废水环境保护控制设施");
        tab4.setTitle("废气、废水环境保护控制设施");
        tab5.setTitle("废气、废水环境保护控制设施");
        tab6.setTitle("废气、废水环境保护控制设施");

        model = (Common_Model) getIntent().getSerializableExtra("model7");
        ...
        imageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("data_model7", model);
        ...
        tab3.setResource(R.layout.add_tab9);
        tab4.setResource(R.layout.add_tab10);
        tab5.setResource(R.layout.model9_tab5);
        tab6.setResource(R.layout.model9_tab7);
    ...
    public class TabPagerAdapter extends FragmentPagerAdapter {
        ...
        public CharSequence getPageTitle(int position) {
            Drawable drawable;
            drawable = ContextCompat.getDrawable(Common_7.this, R.drawable.other_page);
    ...
    public void SendChoice(int choice, int i){
        ...
        else Toast.makeText(Common_7.this, "model空指针!", Toast.LENGTH_SHORT).show();
