...
public class Form_5 extends AppCompatActivity implements TabLayout.OnTabSelectedListener, TabFragment.CallBackValue{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        model = (Model3) getIntent().getSerializableExtra("model3");
        ...
        tab1.setResource(R.layout.model3_tab1);
        tab2.setResource(R.layout.model3_tab2);
        tab3.setResource(R.layout.model3_tab3);
    ...
    public class TabPagerAdapter extends FragmentPagerAdapter {
        ...
        public CharSequence getPageTitle(int position) {
            Drawable drawable;
            drawable = ContextCompat.getDrawable(Form_5.this, R.drawable.other_page);
    ...
    public void SendChoice(int choice, int i){
        ...
        else Toast.makeText(Form_5.this, "model空指针!", Toast.LENGTH_SHORT).show();
