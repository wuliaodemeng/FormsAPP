...
public class Form_4 extends AppCompatActivity implements TabLayout.OnTabSelectedListener, TabFragment.CallBackValue{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        model = (Model2) getIntent().getSerializableExtra("model2");
        ...
        if(model != null) {
            ...
            tab3.setLack_project(model.getLack_project());
    ...
    public void SendChoice(int choice, int i){
        ...
        else Toast.makeText(Form_4.this, "model空指针!", Toast.LENGTH_SHORT).show();

    }
    public void SendLackProject(String lack_project, int i){
        model.setLack_project(lack_project);
    }
