...
public class Form_9 extends AppCompatActivity implements TabLayout.OnTabSelectedListener, TabFragment.CallBackValue{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.form_9);
        tab1.setClassID(37);
        tab2.setClassID(37);
        tab3.setClassID(37);
        tab4.setClassID(37);

        model = (Model7) getIntent().getSerializableExtra("model7");
        ...
        tab4.setResource(R.layout.model7_tab4);
    ...
    public class TabPagerAdapter extends FragmentPagerAdapter {
        ...
        public CharSequence getPageTitle(int position) {
            Drawable drawable;
            drawable = ContextCompat.getDrawable(Form_9.this, R.drawable.other_page);
    ...
    public void SendChoice(int choice, int i){
        ...
        else Toast.makeText(Form_9.this, "model空指针!", Toast.LENGTH_SHORT).show();
