...
public class Form_8 extends AppCompatActivity implements TabLayout.OnTabSelectedListener,TabFragment.CallBackValue{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.form_8);
        tab1.setClassID(36);
        tab2.setClassID(36);
        tab3.setClassID(36);
        tab4.setClassID(36);
        ...
        model = (Model6) getIntent().getSerializableExtra("model6");
        ...
        tab1.setResource(R.layout.model6_tab1);
        tab2.setResource(R.layout.model6_tab2);
        tab3.setResource(R.layout.model6_tab3);
        tab4.setResource(R.layout.model6_tab4);
        tab5.setResource(R.layout.model6_tab5);
    ...
    public class TabPagerAdapter extends FragmentPagerAdapter {
        ...
        public CharSequence getPageTitle(int position) {
            Drawable drawable;
            drawable = ContextCompat.getDrawable(Form_8.this, R.drawable.other_page);
    ...
    public void SendChoice(int choice, int i){
        ...
        else Toast.makeText(Form_8.this, "model空指针!", Toast.LENGTH_SHORT).show();
