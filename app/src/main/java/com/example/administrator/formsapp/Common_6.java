...
public class Common_6 extends AppCompatActivity implements TabLayout.OnTabSelectedListener, TabFragment.CallBackValue{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tab1.setTitle("固废、重点排污单位、环境风险防范措施");
        tab2.setTitle("固废、重点排污单位、环境风险防范措施");
        tab3.setTitle("固废、重点排污单位、环境风险防范措施");
        tab4.setTitle("固废、重点排污单位、环境风险防范措施");

        model = (Common_Model) getIntent().getSerializableExtra("model6");
        ...
        imageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("data_model6", model);
        ...
        tab1.setResource(R.layout.model7_tab1);
        tab2.setResource(R.layout.model7_tab2);
        tab3.setResource(R.layout.model7_tab3);
        tab4.setResource(R.layout.add_tab2);
    ...
    public void onTabReselected(TabLayout.Tab tab) {
        Drawable drawable;
        drawable = ContextCompat.getDrawable(Common_6.this, R.drawable.cur_page);
    ...
    public class TabPagerAdapter extends FragmentPagerAdapter {
        ...
        public CharSequence getPageTitle(int position) {
            Drawable drawable;
            drawable = ContextCompat.getDrawable(Common_6.this, R.drawable.other_page);
            drawable.setBounds(0, 0, drawable.getIntrinsicWidth(), drawable.getIntrinsicHeight());
    ...
    public void SendChoice(int choice, int i){
        ...
        else Toast.makeText(Common_6.this, "model空指针!", Toast.LENGTH_SHORT).show();
