...
public class Mining_8 extends AppCompatActivity implements TabLayout.OnTabSelectedListener, TabFragment.CallBackValue{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        model = (Common_Model) getIntent().getSerializableExtra("model8");
        ...
        imageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("data_model8", model);
        ...
        tab1.setResource(R.layout.mining_tab22);
        tab2.setResource(R.layout.mining_tab23);
        tab3.setResource(R.layout.mining_tab24);
        tab4.setResource(R.layout.mining_tab25);
        tab5.setResource(R.layout.mining_tab26);
        tab6.setResource(R.layout.mining_tab27);
    ...
    public class TabPagerAdapter extends FragmentPagerAdapter {
        ...
        public CharSequence getPageTitle(int position) {
            Drawable drawable;
            drawable = ContextCompat.getDrawable(Mining_8.this, R.drawable.other_page);
    ...
    public void SendChoice(int choice, int i){
        ...
        else Toast.makeText(Mining_8.this, "model空指针!", Toast.LENGTH_SHORT).show();
