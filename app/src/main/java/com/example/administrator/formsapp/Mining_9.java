...
public class Mining_9 extends AppCompatActivity implements TabLayout.OnTabSelectedListener, TabFragment.CallBackValue{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Toast.makeText(this, "" + model.getLack_project(0), Toast.LENGTH_SHORT).show();
        ...
        if(model != null) {
            tab1.setLack_project(model.getLack_project(0));
            tab2.setLack_project(model.getLack_project(1));
            tab3.setLack_project(model.getLack_project(2));
            tab4.setLack_project(model.getLack_project(3));
        ...
        tab1.setResource(R.layout.mining_tab28);
        tab2.setResource(R.layout.mining_tab29);
        tab3.setResource(R.layout.mining_tab30);
        tab4.setResource(R.layout.mining_tab31);
        tab5.setResource(R.layout.mining_tab32);
        tab6.setResource(R.layout.mining_tab33);
        tab7.setResource(R.layout.mining_tab49);
    ...
    public class TabPagerAdapter extends FragmentPagerAdapter {
        ...
        public CharSequence getPageTitle(int position) {
            Drawable drawable;
            drawable = ContextCompat.getDrawable(Mining_9.this, R.drawable.other_page);
    ...
    public void SendChoice(int choice, int i){
        ...
        else Toast.makeText(Mining_9.this, "model空指针!", Toast.LENGTH_SHORT).show();
