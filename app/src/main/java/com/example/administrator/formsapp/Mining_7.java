...
public class Mining_7 extends AppCompatActivity implements TabLayout.OnTabSelectedListener, TabFragment.CallBackValue{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tab1.setResource(R.layout.mining_tab16);
        tab2.setResource(R.layout.mining_tab17);
        tab3.setResource(R.layout.mining_tab18);
        tab4.setResource(R.layout.mining_tab19);
        tab5.setResource(R.layout.mining_tab20);
        tab6.setResource(R.layout.mining_tab21);
    ...
    public class TabPagerAdapter extends FragmentPagerAdapter {
        ...
        public CharSequence getPageTitle(int position) {
            Drawable drawable;
            drawable = ContextCompat.getDrawable(Mining_7.this, R.drawable.other_page);
    ...
    public void SendChoice(int choice, int i){
        ...
        else Toast.makeText(Mining_7.this, "model空指针!", Toast.LENGTH_SHORT).show();
