...
public class Form_7 extends AppCompatActivity implements TabLayout.OnTabSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tab1.setResource(R.layout.model5_tab1);
        tab2.setResource(R.layout.model5_tab2);
        tab3.setResource(R.layout.model5_tab3);
        tab4.setResource(R.layout.model5_tab4);
        tab5.setResource(R.layout.model5_tab5);
        tab6.setResource(R.layout.model5_tab6);
    ...
    public void onTabSelected(TabLayout.Tab tab) {
        Drawable drawable;
        drawable = ContextCompat.getDrawable(Form_7.this, R.drawable.cur_page);
